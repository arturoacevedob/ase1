...
<div class="padding-thing big-margin">
    ...
    <ul class="grid-tabs-42">
        <li class="tab62"><a class="tab-disactive2" href="products_coffee.php" id="coffee" target="_self">Café</a></li>
        <li class="tab72"><a class="active tab-active2"href="products_honey.php" id="honey" target="_self">Miel</a></li>
