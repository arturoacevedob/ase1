    ...
    for ($i = 0; $i < count($products); $i++) {
        ...
        <div class='product-item grid-1-1'>
            ...
            <div class='product-info radius-right'>
                <h3>" . $products[$i]["name_product"] . "<span>" . $products[$i]["client_type"] . "</span><span> <a href='crud_product/update_product.php'>edit</a></span> <span><a href='crud_product/delete_product.php?idproduct=" . $products[$i]["id_product"] ."'>eliminar</a></span></h3>
