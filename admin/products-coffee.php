    ...
    for ($i = 0; $i < count($products); $i++) {
        ...
        <div class='product-item grid-1-1'>
            ...
            <div class='product-info radius-right'>
                <h3>" . $products[$i]["name_product"] . "<span>" . $products[$i]["client_type"] . "</span><span><a href='crud_product/update_product.php?idclient=" . $products[$i]["id_product"] . "'>Editar</a></span></h3>
