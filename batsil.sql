...
--
CREATE DATABASE IF NOT EXISTS `b17_23304306_batsil` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `b17_23304306_batsil`;
...
--
ALTER TABLE `images`
  MODIFY `id_image` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `products`
--
ALTER TABLE `products`
  MODIFY `id_product` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;

--
-- AUTO_INCREMENT for table `weight_price`
--
ALTER TABLE `weight_price`
  MODIFY `id_weight_price` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
